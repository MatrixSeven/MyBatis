...
public class MapperMethod {
	...
	public static class SqlCommand {
		...
		/**
		 * TODO SQL XML 的Slq内容分析类
		 * 			进行,包装方法全方法名字 xxx.xx.xxx.xx()....
		 * @param configuration 		全局的一个配置文件Bean
		 * @param declaringInterface	代理接口
		 * @param method				代理的方法
