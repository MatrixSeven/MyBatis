...
public class XMLStatementBuilder extends BaseBuilder {
	...
	/**
	 * TODO 拿到and包装每一条SQL的返回类型,resmap类型,a d u s(增删改查)类型
	 * id对应java接口方法名
	 */
	public void parseStatementNode() {
		...
		builderAssistant.addMappedStatement(id, sqlSource, statementType, sqlCommandType, fetchSize, timeout,
				...
				resultOrdered, keyGenerator, keyProperty, keyColumn, databaseId, langDriver);
	}
	...
	public void parseSelectKeyNode(String id, XNode nodeToHandle, Class<?> parameterTypeClass,
		...
		builderAssistant.addMappedStatement(id, sqlSource, statementType, sqlCommandType, fetchSize, timeout,
				parameterMap, parameterTypeClass, resultMap, resultTypeClass, resultSetTypeEnum, flushCache, useCache,
				resultOrdered, keyGenerator, keyProperty, null, databaseId, langDriver);
