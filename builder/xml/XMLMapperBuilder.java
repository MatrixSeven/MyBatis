...
/**
 * 其实这货XMLMapperBuilder 就是一个专门负责解析XML的东西
 * 
 * @author seven
 *
 */
public class XMLMapperBuilder extends BaseBuilder {
	...
	/**
	 * context读取后接口类对应的SQL XML文件 ----->现在开始解析xml各个参数
	 * 
	 * @param context
	 *            这个玩意其实就是XNode对象 类似于解析好的DOM树
	 */
	...
	/**
	 * TODO @param list 将SQL XML里面的每一条sql包装成一个XNode对象 打包到这个List里
	 */
	...
	/**
	 * TODO 这个方法就是解析resultMap节点的实现 具体细节思想先放下
	 * 
	 * @param list
	 * @throws Exception
	 */
	...
	/*
	 * TODO 解析与接口对应的XML的结果集合包装参数resultMapElement
	 */
	private ResultMap resultMapElement(XNode resultMapNode, List<ResultMapping> additionalResultMappings)
		...
		/*
		 * TODO 根据自动包装挂载model 写的别名找到数据返回类型对应的挂载实际类型
		 */
		...
		/*
		 * TODO 开始解析数据库查询的行列与Model的属性对应关系
		 */
	...
	/*
	 * TODO 对与接口类的对应的XML继续包装,拿到类型,返回结果集,参数,,,,,,,
	 */
