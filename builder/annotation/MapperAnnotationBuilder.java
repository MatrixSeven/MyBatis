...
public class MapperAnnotationBuilder {
  ...
  /**
   * TODO 包装接口,绑定代理,解析wapper配置xml到动态代理方法的实现步骤
   */
  public void parse() {
 ...
 */
  ...
  private void applyResultMap(String resultMapId, Class<?> returnType, Arg[] args, Result[] results, TypeDiscriminator discriminator) {
    ...
    assistant.addResultMap(resultMapId, returnType, null, disc, resultMappings, null); // add AutoMappingBehaviour
  ...
  private void createDiscriminatorResultMaps(String resultMapId, Class<?> resultType, TypeDiscriminator discriminator) {
    if (discriminator != null) {
      for (Case c : discriminator.cases()) {
        ...
        assistant.addResultMap(caseResultMapId, c.type(), resultMapId, null, resultMappings, null); //add AutoMappingBehaviour
      }
    }
  }
 ...
 */
  ...
  /**
	 * TODO 拿到sqlXML中的注解,其实也就是select update insert delete标签
	 */
  ...
  private KeyGenerator handleSelectKeyAnnotation(SelectKey selectKeyAnnotation, String baseStatementId, Class<?> parameterTypeClass, LanguageDriver languageDriver) {
    ...
    assistant.addMappedStatement(id, sqlSource, statementType, sqlCommandType, fetchSize, timeout, parameterMap, parameterTypeClass, resultMap, resultTypeClass, resultSetTypeEnum,
        flushCache, useCache, false, //  issue #577
